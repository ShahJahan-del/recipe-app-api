...
SECRET_KEY = 'django-insecure-xa_g405wih7c0^q#=u(l4^a8t+5()v45=b+p+xz!1&=m)d6+eq'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'postgres.yvdbgwwsckpepvazitqr',
        'PASSWORD': 'Stankipa45!',
...
# Redirection des e-mails vers le terminal pour le développement
